...
function Wb(a){this.pc=a;this.i=1073741824;this.B=0}Wb.prototype.Lb=function(a,b){return this.pc.append(b)};function Xb(a){var b=new pa;a.K(null,new Wb(b),ya());return""+E(b)}var Yb="undefined"!==typeof Math.imul&&0!==Math.imul(4294967295,5)?function(a,b){return Math.imul(a,b)}:function(a,b){var c=a&65535,d=b&65535;return c*d+((a>>>16&65535)*d+c*(b>>>16&65535)<<16>>>0)|0};function Zb(a){a=Yb(a|0,-862048943);return Yb(a<<15|a>>>-15,461845907)}
...
a.g.b(b,c):a.g.call(null,b,c)}function S(a,b){a=this;return a.g.a?a.g.a(b):a.g.call(null,b)}function la(a){a=this;return a.g.u?a.g.u():a.g.call(null)}var x=null,x=function(Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,x,Wa,eb,rb,Mb,mc,Vc,xe){switch(arguments.length){case 1:return la.call(this,Fa);case 2:return S.call(this,Fa,R);case 3:return I.call(this,Fa,R,T);case 4:return D.call(this,Fa,R,T,W);case 5:return z.call(this,Fa,R,T,W,Z);case 6:return w.call(this,Fa,R,T,W,Z,da);case 7:return v.call(this,Fa,R,
...
Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,x,Wa);case 17:return f.call(this,Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,x,Wa,eb);case 18:return e.call(this,Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,x,Wa,eb,rb);case 19:return d.call(this,Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,x,Wa,eb,rb,Mb);case 20:return c.call(this,Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,x,Wa,eb,rb,Mb,mc);case 21:return b.call(this,Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,x,Wa,eb,rb,Mb,mc,Vc);case 22:return a.call(this,Fa,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,
Ga,Ka,x,Wa,eb,rb,Mb,mc,Vc,xe)}throw Error("Invalid arity: "+arguments.length);};x.a=la;x.b=S;x.c=I;x.o=D;x.C=z;x.V=w;x.W=v;x.na=t;x.oa=r;x.ca=q;x.da=p;x.ea=n;x.fa=m;x.ga=l;x.ha=k;x.ia=h;x.ja=f;x.ka=e;x.la=d;x.ma=c;x.Cb=b;x.eb=a;return x}();g.apply=function(a,b){return this.call.apply(this,[this].concat(Qa(b)))};g.u=function(){return this.g.u?this.g.u():this.g.call(null)};g.a=function(a){return this.g.a?this.g.a(a):this.g.call(null,a)};
...
g.R=function(a,b){return new Oc(b,this.first,this.sa,this.count,this.s)};g.T=function(a,b){return new Oc(this.v,b,this,this.count+1,null)};Oc.prototype[Pa]=function(){return tc(this)};function Hd(a){this.v=a;this.i=65937614;this.B=8192}g=Hd.prototype;g.toString=function(){return Xb(this)};g.equiv=function(a){return this.w(null,a)};g.O=function(){return this.v};g.pa=function(){return null};g.X=function(){return 0};g.N=function(){return yc};
...
g.toString=function(){return Xb(this)};g.equiv=function(a){return this.w(null,a)};g.O=function(){return this.v};g.pa=function(){return null==this.sa?null:K(this.sa)};g.N=function(){var a=this.s;return null!=a?a:this.s=a=xc(this)};g.w=function(a,b){return Cc(this,b)};g.Y=function(a,b){return Sc.b(b,this)};g.Z=function(a,b,c){return Sc.c(b,c,this)};g.$=function(){return this.first};g.qa=function(){return null==this.sa?rc:this.sa};g.S=function(){return this};
...
function Ld(a,b,c,d){this.v=a;this.Ya=b;this.F=c;this.s=d;this.i=32374988;this.B=0}g=Ld.prototype;g.toString=function(){return Xb(this)};g.equiv=function(a){return this.w(null,a)};function Md(a){null!=a.Ya&&(a.F=a.Ya.u?a.Ya.u():a.Ya.call(null),a.Ya=null);return a.F}g.O=function(){return this.v};g.pa=function(){xb(this);return null==this.F?null:M(this.F)};g.N=function(){var a=this.s;return null!=a?a:this.s=a=xc(this)};g.w=function(a,b){return Cc(this,b)};g.Y=function(a,b){return Sc.b(b,this)};
...
Td.u=function(){return new Ld(null,function(){return null},null,null)};Td.a=function(a){return new Ld(null,function(){return a},null,null)};Td.b=function(a,b){return new Ld(null,function(){var c=K(a);return c?kd(c)?Pd(Nb(c),Td.b(Ob(c),b)):O(L(c),Td.b(qc(c),b)):b},null,null)};Td.l=function(a,b,c){return function e(a,b){return new Ld(null,function(){var c=K(a);return c?kd(c)?Pd(Nb(c),e(Ob(c),b)):O(L(c),e(qc(c),b)):y(b)?e(L(b),M(b)):null},null,null)}(Td.b(a,b),c)};
...
g.equiv=function(a){return this.w(null,a)};g.w=function(a,b){return this===b};g.tb=function(){return this.state};g.O=function(){return this.v};g.Kb=function(a,b,c){a=K(this.vb);for(var d=null,e=0,f=0;;)if(f<e){var h=d.U(null,f),k=P(h,0),h=P(h,1);h.o?h.o(k,this,b,c):h.call(null,k,this,b,c);f+=1}else if(a=K(a))kd(a)?(d=Nb(a),a=Ob(a),k=d,e=Xc(d),d=k):(d=L(a),k=P(d,0),h=P(d,1),h.o?h.o(k,this,b,c):h.call(null,k,this,b,c),a=M(a),d=null,e=0),f=0;else return null};
...
Q.b=function(a,b){return new Ld(null,function(){var c=K(b);if(c){if(kd(c)){for(var d=Nb(c),e=Xc(d),f=new Od(Array(e),0),h=0;;)if(h<e)Qd(f,function(){var b=G.b(d,h);return a.a?a.a(b):a.call(null,b)}()),h+=1;else break;return Pd(f.za(),Q.b(a,Ob(c)))}return O(function(){var b=L(c);return a.a?a.a(b):a.call(null,b)}(),Q.b(a,qc(c)))}return null},null,null)};
...
te.l=function(a,b,c){return new Ld(null,function(){var d=Q.b(K,Uc.l(c,b,oc([a],0)));return be(ud,d)?Td.b(Q.b(L,d),F.b(te,Q.b(qc,d))):null},null,null)};te.D=function(a){var b=L(a),c=M(a);a=L(c);c=M(c);return te.l(b,a,c)};te.A=2;ue;function ve(a,b){return F.b(Td,F.c(Q,a,b))}
function we(a,b){return new Ld(null,function(){var c=K(b);if(c){if(kd(c)){for(var d=Nb(c),e=Xc(d),f=new Od(Array(e),0),h=0;;)if(h<e){var k;k=G.b(d,h);k=a.a?a.a(k):a.call(null,k);y(k)&&(k=G.b(d,h),f.add(k));h+=1}else break;return Pd(f.za(),we(a,Ob(c)))}d=L(c);c=qc(c);return y(a.a?a.a(d):a.call(null,d))?O(d,we(a,c)):we(a,c)}return null},null,null)}
function ye(a){return function c(a){return new Ld(null,function(){return O(a,y(od.a?od.a(a):od.call(null,a))?ve(c,oc([K.a?K.a(a):K.call(null,a)],0)):null)},null,null)}(a)}function ze(a,b,c){return new Ld(null,function(){var d=K(c);if(d){var e=oe(a,d);return a===Xc(e)?O(e,ze(a,b,re(b,d))):null}return null},null,null)}function Ae(a,b){this.L=a;this.f=b}
...
Pe.o=function(a,b,c,d){return new jd(a,b,c,d,null,null)};Pe.C=function(a,b,c,d,e){return new jd(a,b,c,d,e,null)};Pe.A=5;Re;function Se(a,b,c,d,e){this.v=a;this.Ha=b;this.start=c;this.end=d;this.s=e;this.i=167666463;this.B=8192}g=Se.prototype;g.toString=function(){return Xb(this)};g.equiv=function(a){return this.w(null,a)};g.J=function(a,b){return cb.c(this,b,null)};g.H=function(a,b,c){return"number"===typeof b?G.c(this,b,c):c};
...
a.length,d=0;;){if(c<=d){c=-1;break a}if(ec.b(b,a[d])){c=d;break a}d+=2}return c}bf;function cf(a,b,c){this.f=a;this.j=b;this.ya=c;this.i=32374990;this.B=0}g=cf.prototype;g.toString=function(){return Xb(this)};g.equiv=function(a){return this.w(null,a)};g.O=function(){return this.ya};g.pa=function(){return this.j<this.f.length-2?new cf(this.f,this.j+2,this.ya):null};g.X=function(){return(this.f.length-this.j)/2};g.N=function(){return xc(this)};g.w=function(a,b){return Cc(this,b)};
...
function Jf(a,b,c){this.v=a;this.Sa=b;this.s=c;this.i=15077647;this.B=8196}g=Jf.prototype;g.toString=function(){return Xb(this)};g.equiv=function(a){return this.w(null,a)};g.keys=function(){return tc(K(this))};g.entries=function(){var a=K(this);return new $e(K(a))};g.values=function(){return tc(K(this))};g.has=function(a){return qd(this,a)};
...
function Of(a,b){for(var c=K(b),d=null,e=0,f=0;;)if(f<e){var h=d.U(null,f);Ab(a,h);f+=1}else if(c=K(c))d=c,kd(d)?(c=Nb(d),e=Ob(d),d=c,h=Xc(c),c=e,e=h):(h=L(d),Ab(a,h),c=M(d),d=null,e=0),f=0;else return null}var Pf={'"':'\\"',"\\":"\\\\","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t"};function Qf(a){return[E('"'),E(a.replace(RegExp('[\\\\"\b\f\n\r\t]',"g"),function(a){return Pf[a]})),E('"')].join("")}Rf;
...
var ie=function ie(b){for(var c=[],d=arguments.length,e=0;;)if(e<d)c.push(arguments[e]),e+=1;else break;return ie.l(0<c.length?new J(c.slice(0),0):null)};ie.l=function(a){var b=ya();if(null==a||Na(K(a)))b="";else{var c=E,d=new pa;a:{var e=new Wb(d);Oe(L(a),e,b);a=K(M(a));for(var f=null,h=0,k=0;;)if(k<h){var l=f.U(null,k);Ab(e," ");Oe(l,e,b);k+=1}else if(a=K(a))f=a,kd(f)?(a=Nb(f),h=Ob(f),f=a,l=Xc(a),a=h,h=l):(l=L(f),Ab(e," "),Oe(l,e,b),a=M(f),f=null,h=0),k=0;else break a}b=""+c(d)}return b};ie.A=0;
...
var cg=function cg(b){if(null==b)return null;if(null!=b?b.Sb||(b.fc?0:B(ag,b)):B(ag,b))return bg(b);if(b instanceof A)return Cd(b);if(b instanceof dc)return""+E(b);if(gd(b)){var c={};b=K(b);for(var d=null,e=0,f=0;;)if(f<e){var h=d.U(null,f),k=P(h,0),h=P(h,1);c[dg(k)]=cg(h);f+=1}else if(b=K(b))kd(b)?(e=Nb(b),b=Ob(b),d=e,e=Xc(e)):(e=L(b),d=P(e,0),e=P(e,1),c[dg(d)]=cg(e),b=M(b),d=null,e=0),f=0;else break;return c}if(null==b?0:null!=b?b.i&8||b.sc||(b.i?0:B(Ua,b)):B(Ua,b)){c=[];b=K(Q.b(cg,b));d=null;for(f=
e=0;;)if(f<e)k=d.U(null,f),c.push(k),f+=1;else if(b=K(b))d=b,kd(d)?(b=Nb(d),f=Ob(d),d=b,e=Xc(b),b=f):(b=L(d),c.push(b),b=M(d),d=null,e=0),f=0;else break;return c}return b},$f=function $f(b){for(var c=[],d=arguments.length,e=0;;)if(e<d)c.push(arguments[e]),e+=1;else break;switch(c.length){case 0:return $f.u();case 1:return $f.a(arguments[0]);default:throw Error([E("Invalid arity: "),E(c.length)].join(""));}};$f.u=function(){return $f.a(1)};$f.a=function(a){return Math.random()*a};$f.A=1;
...
d);return e.b?e.b(b,c):e.call(null,b,c)}function S(a,b){a=this;var c=a.h.a?a.h.a(b):a.h.call(null,b),d=Y(this,c);y(d)||X(a.name,c);return d.a?d.a(b):d.call(null,b)}function la(a){a=this;var b=a.h.u?a.h.u():a.h.call(null),c=Y(this,b);y(c)||X(a.name,b);return c.u?c.u():c.call(null)}var x=null,x=function(x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa,eb,rb,Mb,mc,Vc,xe){switch(arguments.length){case 1:return la.call(this,x);case 2:return S.call(this,x,R);case 3:return I.call(this,x,R,T);case 4:return D.call(this,
...
ka,qa,Aa,Ga,Ka);case 15:return k.call(this,x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb);case 16:return h.call(this,x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa);case 17:return f.call(this,x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa,eb);case 18:return e.call(this,x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa,eb,rb);case 19:return d.call(this,x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa,eb,rb,Mb);case 20:return c.call(this,x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa,eb,rb,Mb,mc);case 21:return b.call(this,x,R,T,
W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa,eb,rb,Mb,mc,Vc);case 22:return a.call(this,x,R,T,W,Z,da,fa,ha,ia,ka,qa,Aa,Ga,Ka,Vb,Wa,eb,rb,Mb,mc,Vc,xe)}throw Error("Invalid arity: "+arguments.length);};x.a=la;x.b=S;x.c=I;x.o=D;x.C=z;x.V=w;x.W=v;x.na=t;x.oa=r;x.ca=q;x.da=p;x.ea=n;x.fa=m;x.ga=l;x.ha=k;x.ia=h;x.ja=f;x.ka=e;x.la=d;x.ma=c;x.Cb=b;x.eb=a;return x}();g.apply=function(a,b){return this.call.apply(this,[this].concat(Qa(b)))};
...
if("undefined"===typeof Ph){var Ph,Qh;var Rh=location.hash,Sh=/#/;if("string"===typeof Sh)Qh=Rh.replace(new RegExp(String(Sh).replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08"),"g"),"");else if(Sh instanceof RegExp)Qh=Rh.replace(new RegExp(Sh.source,"g"),"");else throw[E("Invalid match arg: "),E(Sh)].join("");var Th=Qh;Ph=y(/^[\s\xa0]*$/.test(null==Th?"":String(Th)))?null:parseInt(Qh)}
function Uh(a){var b=Mf(function(a){return F.b(xd,a)},function(a){return F.b(wd,a)}),c=function(){var c=Q.b(L,a);return b.a?b.a(c):b.call(null,c)}(),d=P(c,0),c=P(c,1),e=function(){var c=Q.b(Tc,a);return b.a?b.a(c):b.call(null,c)}(),f=P(e,0),e=P(e,1);return new U(null,4,5,V,[d,f,c-d,e-f],null)}
function Vh(){var a=Wh,b=N.a?N.a(Xh):N.call(null,Xh),c=null!=b&&(b.i&64||b.Ia)?F.b(Bc,b):b,d=H.b(c,Lg);return new U(null,3,5,V,[Vg,$d,new U(null,4,5,V,[Jg,$d,new U(null,3,5,V,[Jg,$d,new U(null,3,5,V,[xg,new za(null,2,[Hg,"unprinted",Bg,function(){return function(){return a.a?a.a(zg):a.call(null,zg)}}(600,b,c,c,d)],null),"New Island"],null)],null),new U(null,3,5,V,[Jg,$d,new U(null,4,5,V,[Og,new za(null,2,[Ag,600,Yg,600],null),new U(null,2,5,V,[Xg,new za(null,3,[Ng,"water",Ag,600,Yg,600],null)],null),
function(){var a=Q.b(Sg,d),b=V,c,k=Uh(a),l=new U(null,4,5,V,[0,0,600,600],null);c=P(k,0);var m=P(k,1),n=P(k,2),k=P(k,3),p=P(l,0),q=P(l,1),r=P(l,2),l=P(l,3),t;t=r/n;var v=l/k;t=t<v?t:v;c=[E(Fh(p+r/2,q+l/2)),E("scale("),E(.95*t),E(")"),E(Fh(-(c+n/2),-(m+k/2)))].join("");a=K(a)?[E(Hh(a)),E("Z")].join(""):"";return new U(null,2,5,b,[tg,new za(null,3,[Ng,"island",ug,c,Tg,a],null)],null)}()],null)],null)],null)],null)}function Yh(a){return new za(null,3,[wg,Ih(a),Kg,Ih(a),Pg,.05+Ih(a)],null)}
function Zh(a,b){return function d(b){return new Ld(null,function(){for(;;){var f=K(b);if(f){if(kd(f)){var h=Nb(f),k=Xc(h),l=new Od(Array(k),0);return function(){for(var b=0;;)if(b<k){var d=G.b(h,b),e=Yh(a),f=e=null!=e&&(e.i&64||e.Ia)?F.b(Bc,e):e,m=H.b(e,wg),n=H.b(e,Kg);Qd(l,Gf.l(oc([f,new za(null,3,[Mg,Yf("radial"),Sg,function(){var a=100*(1+(m-n));return new U(null,2,5,V,[a*(Kh.a?Kh.a(d):Kh.call(null,d)),a*(Jh.a?Jh.a(d):Jh.call(null,d))],null)}(),Eg,new za(null,4,[Dg,Qg,Ig,new U(null,2,5,V,[0,0],
null),Fg,d,Gg,100],null)],null)],0)));b+=1}else return!0}()?Pd(l.za(),d(Ob(f))):Pd(l.za(),null)}var m=L(f),n=Yh(a),p=n=null!=n&&(n.i&64||n.Ia)?F.b(Bc,n):n,q=H.b(n,wg),r=H.b(n,Kg);return O(Gf.l(oc([p,new za(null,3,[Mg,Yf("radial"),Sg,function(){var a=100*(1+(q-r));return new U(null,2,5,V,[a*(Kh.a?Kh.a(m):Kh.call(null,m)),a*(Jh.a?Jh.a(m):Jh.call(null,m))],null)}(),Eg,new za(null,4,[Dg,Qg,Ig,new U(null,2,5,V,[0,0],null),Fg,m,Gg,100],null)],null)],0)),d(qc(f)))}return null}},null,null)}(new Lf(null,0,
Lh,Lh/b,null))}
function $h(a,b,c){var d=P(b,0);b=P(b,1);b=new U(null,2,5,V,[d,b],null);d=P(b,0);b=P(b,1);if(0<=c&&2<=Nh(Sg.a(d),Sg.a(b))){c=Ih(a);var e=Oh(Q.b(Pg,new U(null,2,5,V,[d,b],null))),f=Oh(Q.b(Kg,new U(null,2,5,V,[d,b],null))),h=Yf("midpoint"),k=Sg.a(d),l=P(k,0),m=P(k,1),n=Sg.a(b),p=P(n,0),q=P(n,1),k=Nh(k,n),k=e*k*(c-f),r=new U(null,2,5,V,[Oh(new U(null,2,5,V,[l,p],null)),Oh(new U(null,2,5,V,[m,q],null))],null),n=P(r,0),r=P(r,1),m=new U(null,2,5,V,[-(m-q),l-p],null),l=P(m,0),m=P(m,1),p=Nh(new U(null,2,
5,V,[0,0],null),new U(null,2,5,V,[l,m],null)),m=new U(null,2,5,V,[l/p,m/p],null),l=P(m,0),m=P(m,1);c=new za(null,6,[Mg,h,wg,c,Kg,f,Pg,e,Sg,new U(null,2,5,V,[n+k*l,r+k*m],null),Eg,new za(null,3,[Dg,Cg,Zg,Mg.a(d),Rg,Mg.a(b)],null)],null);a=Td.b($h(a,new U(null,2,5,V,[d,c],null),1),$h(a,new U(null,2,5,V,[c,b],null),1))}else a=new U(null,1,5,V,[d],null);return a}
function ai(a){var b=17*Ih(a)|0,c=3+b,d=Zh(a,c),e=Td.b(d,new U(null,1,5,V,[L(d)],null)),f=ze(2,1,e);return ve(function(){return function(b){return $h(a,b,15)}}(b,c,d,e,f),oc([f],0))}if("undefined"===typeof Xh){var Xh,bi,ci=y(Ph)?Ph:eg();bi=new Ch(ci);var di=new za(null,2,[rg,bi,Lg,ai(bi)],null);Xh=ge.a?ge.a(di):ge.call(null,di)}
if("undefined"===typeof Wh)var Wh=function(){var a=ge.a?ge.a($d):ge.call(null,$d),b=ge.a?ge.a($d):ge.call(null,$d),c=ge.a?ge.a($d):ge.call(null,$d),d=ge.a?ge.a($d):ge.call(null,$d),e=H.c($d,Wg,gg());return new qg(nc.b("isle.core","emit"),function(){return function(){function a(b,c){if(1<arguments.length)for(var d=0,e=Array(arguments.length-1);d<e.length;)e[d]=arguments[d+1],++d;return b}a.A=1;a.D=function(a){var b=L(a);qc(a);return b};a.l=function(a){return a};return a}()}(a,b,c,d,e),yg,e,a,b,c,d)}();
var ei=Wh;me.o(ei.$a,ad,zg,function(){var a=eg(),b=new Ch(a);location.hash=a;return me.b(Xh,function(a,b){return function(a){return ad.l(a,rg,b,oc([Lg,ai(b)],0))}}(a,b))});mg(ei.pb,ei.$a,ei.bb,ei.nb);if("undefined"===typeof fi)var fi=function(a){return function(){var b=Vh();return a.a?a.a(b):a.call(null,b)}}(zh());if("undefined"===typeof gi){var gi,hi=Xh;Db(hi,Ug,function(a,b,c,d){return fi.a?fi.a(d):fi.call(null,d)});gi=hi}var ii=N.a?N.a(Xh):N.call(null,Xh);fi.a?fi.a(ii):fi.call(null,ii);