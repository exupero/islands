...
rh(d);d=function(){var b=M.a?M.a(a):M.call(null,a);return kh.b?kh.b(b,l):kh.call(null,b,l)}();fe.b?fe.b(a,l):fe.call(null,a,l);d=function(a,b,c,d){return function(){return ie.c(d,lh,b)}}(l,d,a,b,c);return c.a?c.a(d):c.call(null,d)}}(b,c,d)};function th(a,b){return[E("translate("),E(a),E(","),E(b),E(")")].join("")}function uh(a){var b=O(a,0);a=O(a,1);return[E(b),E(","),E(a)].join("")}function vh(a){a=P.b(uh,a);a=ne(1,pe.b(oe("L"),a));a=Yf(a).join("");return[E("M"),E(a)].join("")};function wh(a){this.mb=a}wh.prototype.gc=function(a){return this.mb.a?this.mb.a(a):this.mb.call(null,a)};function xh(a){return new wh(a)}ba("Hook",wh);ba("Hook.prototype.hook",wh.prototype.gc);var yh=Math.sin,zh=Math.cos,Ah=2*Math.PI,Bh=Math.sqrt;function Ch(a,b){var c=O(a,0),d=O(a,1),e=O(b,0),f=O(b,1),c=Math.pow(c-e,2)+Math.pow(d-f,2);return Bh.a?Bh.a(c):Bh.call(null,c)}function Dh(a){return Qa.b(ud,a)/Wc(a)};ta=function(){function a(a){var d=null;if(0<arguments.length){for(var d=0,e=Array(arguments.length-0);d<e.length;)e[d]=arguments[d+0],++d;d=new pc(e,0)}return b.call(this,d)}function b(a){return console.log.apply(console,Ha.a?Ha.a(a):Ha.call(null,a))}a.A=0;a.G=function(a){a=J(a);return b(a)};a.m=b;return a}();
...
function Fh(a,b){var c=O(a,0),d=O(a,1),e=O(a,2),f=O(a,3),h=O(b,0),k=O(b,1),l=O(b,2),m=O(b,3),n;n=l/e;var p=m/f;n=n<p?n:p;return[E(th(h+l/2,k+m/2)),E("scale("),E(.95*n),E(")"),E(th(-(c+e/2),-(d+f/2)))].join("")}
...
2,5,V,[mg,new ya(null,3,[Fg,"island",Lg,function(){var a=P.b(Kg,d);return J(a)?[E(vh(a)),E("Z")].join(""):""}(),ng,xh(Gh(function(a){return function(b){return b.setAttribute("transform",Fh(Eh(b),new Q(null,4,5,V,[0,0,a,a],null)))}}(600,b,c,c,d)))],null)],null)],null)],null)],null)],null)}function Kh(){return new ya(null,3,[pg,Vf.u(),Cg,Vf.u(),Hg,.05+Vf.u()],null)}
function Lh(a){return function c(a){return new Id(null,function(){for(;;){var e=J(a);if(e){if(jd(e)){var f=Mb(e),h=Wc(f),k=new Ld(Array(h),0);return function(){for(var a=0;;)if(a<h){var c=H.b(f,a),d=Kh(),e=d=null!=d&&(d.i&64||d.Ia)?F.b(Bc,d):d,l=I.b(d,pg),m=I.b(d,Cg);Nd(k,Cf.m(nc([e,new ya(null,3,[Eg,Tf("radial"),Kg,function(){var a=100*(1+(l-m));return new Q(null,2,5,V,[a*(zh.a?zh.a(c):zh.call(null,c)),a*(yh.a?yh.a(c):yh.call(null,c))],null)}(),xg,new ya(null,4,[wg,Ig,Ag,new Q(null,2,5,V,[0,0],null),
yg,c,zg,100],null)],null)],0)));a+=1}else return!0}()?Md(k.za(),c(Nb(e))):Md(k.za(),null)}var l=K(e),m=Kh(),n=m=null!=m&&(m.i&64||m.Ia)?F.b(Bc,m):m,p=I.b(m,pg),q=I.b(m,Cg);return N(Cf.m(nc([n,new ya(null,3,[Eg,Tf("radial"),Kg,function(){var a=100*(1+(p-q));return new Q(null,2,5,V,[a*(zh.a?zh.a(l):zh.call(null,l)),a*(yh.a?yh.a(l):yh.call(null,l))],null)}(),xg,new ya(null,4,[wg,Ig,Ag,new Q(null,2,5,V,[0,0],null),yg,l,zg,100],null)],null)],0)),c(qc(e)))}return null}},null,null)}(new Hf(null,0,Ah,Ah/
a,null))}
function Mh(a,b){var c=O(a,0),d=O(a,1);d=new Q(null,2,5,V,[c,d],null);c=O(d,0);d=O(d,1);if(0<=b&&2<=Ch(Kg.a(c),Kg.a(d))){var e;e=Vf.u();var f=Dh(P.b(Hg,new Q(null,2,5,V,[c,d],null))),h=Dh(P.b(Cg,new Q(null,2,5,V,[c,d],null))),k=Tf("midpoint"),l=Kg.a(c),m=O(l,0),n=O(l,1),p=Kg.a(d),q=O(p,0),r=O(p,1),l=Ch(l,p),l=f*l*(e-h),t=new Q(null,2,5,V,[Dh(new Q(null,2,5,V,[m,q],null)),Dh(new Q(null,2,5,V,[n,r],null))],null),p=O(t,0),t=O(t,1),n=new Q(null,2,5,V,[-(n-r),m-q],null),m=O(n,0),n=O(n,1),q=Ch(new Q(null,2,
...
function Nh(){var a=Math.floor(17*Math.random()),b=3+a,c=Lh(b),d=Qd.b(c,new Q(null,1,5,V,[K(c)],null)),e=ve(2,1,d);return se(function(){return function(a){return Mh(a,10)}}(a,b,c,d,e),nc([e],0))}if("undefined"===typeof Jh){var Jh,Oh=new ya(null,1,[Mg,20],null);Jh=W.a?W.a(Oh):W.call(null,Oh)}
